...
func ExampleSortByPriceToBig() {
	result := SortByPriceToBig(homes)
	fmt.Println(result)
...
func ExampleSortByPriceToSmall() {
	result := SortByPriceToSmall(homes)
	fmt.Print(result)
...
func ExampleSortByDistanceFromCenterToFar()  {
	result := SortByDistanceFromCenterToFar(homes)
	fmt.Print(result)
...
func ExampleSortByDistanceFromCenterFromFar()  {
	result := SortByDistanceFromCenterFromFar(homes)
	fmt.Print(result)
